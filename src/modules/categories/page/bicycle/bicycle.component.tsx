...
const Bicycle = hoc(useBicycleProps, ({ isLoading, data, onAdd, SetRouterQuery, GetRouterQuery, setOpen, values, columns, open,
}) => {
    return (
        <div>
            <Header title="Bicycle" buttonText="Add Bicycle" type="primary" onAdd={onAdd} />
            <div className="mt-4">
                <Table
                    loading={isLoading}
