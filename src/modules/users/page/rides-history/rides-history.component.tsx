...
export const RidesHistory = hoc(useRidesHistoryProps, ({data, columns, isLoading, GetRouterQuery, SetRouterQuery, options, userLoading}) => {
    return (
        <div>
            <Header title='Rides history' type='primary' filterType='userId' placeholder='Select user' options={options} isLoading={userLoading} isButton={false} isSelect={true}/>
          <div className="mt-4">
            <Table
              loading={isLoading}
