...
import { useRegionsProps } from "../page/regions/regions.props";
    ...
    return (
        ...
        >
            <FormContainer
                ...
                onSuccess={() => {
                    message.success(!get(values, 'id') ? 'Region created successfully' : "Region updated successfully");
                    onClose();
                    refetch();
                }}
                customData={{
